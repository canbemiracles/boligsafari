...
?>
  ...
  <?php } ?>
  <form class="form-horizontal" enctype="multipart/form-data" method="post" action="frameld.php" id="commentForm">
   ...
   <div class="control-group">
      <label class="control-label text-info">Brugernavn</label>
      <div class="controls">
        <input type="text" title="" name="ssPhone2" value="<?php if($ssAct=='send' && $rememberFields=='yes') { echo "$ssPhone2"; } ?>" class="required">
      </div>
    </div>
    <div class="control-group">
      <label class="control-label text-info">Telefon nr.</label>
      <div class="controls">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <button type="submit" class="btn btn-success">Frameld</button>
      </div>
    </div>
  </form>
  <br />
