    ...
    <div class="box">
      ...
      <div class="box-content">
          ...
          <div class="form-group">
              ...
              <div class="col-sm-4 col-lg-5 controls">
                  <input type="text" name="admin_estate_ac" value="<?php echo(set_value('AC'.$lang->short_name)!='')?set_value('AC'.$lang->short_name):'';?>" placeholder="<?php echo lang_key('AC');?>" class="form-control input-sm" >
                  <span class="help-inline">&nbsp;</span>
                  <?php echo form_error('condition'); ?>
              </div>
          </div>
          ...
          <div class="form-group">
              ...
              <div class="col-sm-4 col-lg-5 controls">
                  <input type="text" name="admin_estate_takeover_date" value="<?php echo(set_value('Takeover Date'.$lang->short_name)!='')?set_value('Takeover Date'.$lang->short_name):'';?>" placeholder="<?php echo lang_key('Takeover Date');?>" class="form-control input-sm" >
                  <span class="help-inline">&nbsp;</span>
                  <?php echo form_error('condition'); ?>
              </div>
          </div>
