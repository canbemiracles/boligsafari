...

	{
...

		{
			...
			else
			{
                ...
                $data['ac'] = $this->input->post('admin_estate_ac');

                $data['prepaid_rent'] = $this->input->post('admin_estate_prepaid_rent');

                $data['deposit'] = $this->input->post('admin_estate_deposit');

                $data['takeover_date'] = $this->input->post('admin_estate_takeover_date');
