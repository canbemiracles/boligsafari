<div class="widget">
    ...
    <div class="well">
        <form class="mortgage-form">
            ...
            <input  type="reset" value="Reset" class="btn btn-warning" style="width:100px" />&nbsp;&nbsp;
            <input type="submit" value="Calculate" class="b js-calculate-button btn btn-warning"  style="width:100px"/>
            </div>
