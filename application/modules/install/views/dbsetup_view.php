...
<fieldset>
	...
	<input type="text" name="db_pass" value="<?php if(set_value('db_pass')!='')echo set_value('db_pass');else echo 'vertrigo';?>" placeholder="" class="input-xxlarge" >
	<?php echo form_error('db_pass'); ?>
	<label>DB Name :</label> 
	<input type="text" name="db_name" value="<?php if(set_value('db_name')!='')echo set_value('db_name');else echo 'memento';?>" placeholder="Db name" class="input-xxlarge" >
