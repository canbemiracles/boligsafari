    ...
    <header id="head">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <!--    <div class="search-divider">Søg efter by</div> -->

                    <div class="clearfix"></div>

                    <a href="/index.php/da/results/plainkey=Århus%7C" style="color:white;font-size:16px;font-weight:bold;">Aarhus</a> - <a href="/index.php/da/results/plainkey=København%7C" style="color:white;font-size:16px;font-weight:bold;">København</a> - <a href="/index.php/da/results/plainkey=Odense%7C" style="color:white;font-size:16px;font-weight:bold;">Odense</a> - <a href="/index.php/da/results/plainkey=Aalborg%7C" style="color:white;font-size:16px;font-weight:bold;">Aalborg</a>
