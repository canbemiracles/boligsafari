                ...
                <div style="margin-top:10px"></div>
                    <div class="col-md-3 col-sm-3">
                        <div class="property-header">
                            ...
                            <img class="property-header-image" src="<?php echo get_featured_photo_by_id($row->featured_img);?>" alt="<?php echo character_limiter($title,100);?>" style="width:100%">
                    ...
                    <div class="col-md-9 col-sm-9">
                        <div class="caption" style="padding: 2px;">                            
                            <h2 class="list-estate-title"><?php echo character_limiter($title,100);?></h2>
                            <p><?php echo mb_convert_case(get_location_name_by_id($row->city), MB_CASE_TITLE, "UTF-8"); ?></p>
