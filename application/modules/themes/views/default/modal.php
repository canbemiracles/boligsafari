        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?php echo site_url('account/login');?>" method="post">
                     ...
                     <div class="row">
                        <div class="col-sm-12">
                            <button type="submit" class="btn btn-primary pull-left"> Log ind</button>
                            <a style="margin:10px 0 0 10px;" href="<?php echo site_url('account/register');?>">Opret lejeprofil</a><a style="margin-left:10px;" href="<?php echo site_url('account/recoverpassword');?>">Glemt password?</a>
                        </div>
                     </div>
                </form>
            </div>
                ...
                <form action="<?php echo site_url('account/register');?>" method="post">
                     ...
                     <div class="row">
                        <div class="col-sm-12">
                            ...
                            <a style="margin:10px 0 0 10px;" href="<?php echo site_url('account/trylogin');?>">Opret lejeprofil</a><a style="margin-left:10px;" href="<?php echo site_url('account/recoverpassword');?>">Glemt password?</a>
                        </div>
                     </div>
                </form>
            </div>
