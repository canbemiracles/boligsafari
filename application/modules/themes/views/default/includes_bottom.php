                ...
                <form action="<?php echo site_url('account/login');?>" method="post">
                     ...
                     <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <a style="margin:10px 0 0 10px;" href="<?php echo site_url('account/signup');?>">Opret lejeprofil</a><a style="margin-left:10px;" href="<?php echo site_url('account/recoverpassword');?>">Glemt password?</a>
