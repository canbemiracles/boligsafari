...
?>
            ...
            ?>
                ...
                <div class="col-md-4 col-sm-4 facility <?php echo $pclass;?>" <?php if($flag==1 || $flag==2) { ?> style = max-width:280px;max-height:100px; <?php } ?> >
                    <div class="thumbnail thumb-shadow">
                        ...
                        <div class="caption">                            
                            ...
                            <p class="estate-description"><?php echo get_location_name_by_id($row->city)?>
</p>
