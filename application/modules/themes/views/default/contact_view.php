        <div class="row">
            ...
            <article class="col-sm-9 maincontent">
                    ...
                    <form action="<?php echo site_url('show/sendcontactemail');?>" method="post">
                        <div class="row">
                            <div class="col-sm-6">
                                <input class="form-control" type="text" name="sender_name" value="<?php echo set_value('sender_name');?>" placeholder="Navn">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <textarea placeholder="Skriv din besked til os her :-)" class="form-control" rows="9" name="msg"><?php echo set_value('msg');?></textarea>
