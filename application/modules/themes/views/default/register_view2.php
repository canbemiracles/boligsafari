                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <?php if(get_settings('realestate_settings','enable_pricing','Yes')=='Yes'){?>    
                                <label>Oprettelse af lejeprofil på Lejibyen.dk:</label>
                                <div class="thumbnail thumb-shadow">                                    
                                    <div class="caption">
                                        ...
                                        <div style="clear:both;">
                                            ...
                                            <span style="float:right; ">10 DKK</span>
                                        </div>
                                        <div style="clear:both; border-bottom:1px solid #ccc; margin:10px 0px;"></div>
                                        <div style="clear:both;">
                                            <span style="float:left; font-weight:bold;">Varighed:</span>
                                            <span style="float:right; ">3 mdr.</span>
                                        </div>
                                        <div style="clear:both; border-bottom:1px solid #ccc; margin:10px 0px;"></div>
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <label class="checkbox">
                                            ...
                                            Jeg har læst <a target="_blank" href="<?php echo site_url('show/page/betingelser');?>">handelsbetingelserne.</a>
                                        </label>
